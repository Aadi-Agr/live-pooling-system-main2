...
const PollHistoryPage = () => {
  ...
  useEffect(() => {
    const getPolls = async () => {
      ...
      try {
        const response = await axios.get(`${apiUrl}/poll-history/${username}`);
        console.log("Poll history received:", response.data);
                ...
                <div className="card-body">
                  ...
                  <div className="list-group mt-4">
                    {poll.options.map((option) => {
                      // Get vote count for this option from the votes object
                      const voteCount = poll.votes?.[option.text] || 0;
