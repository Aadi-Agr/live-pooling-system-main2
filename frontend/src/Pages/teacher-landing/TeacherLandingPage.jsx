...
const TeacherLandingPage = () => {
  ...
  useEffect(() => {
    ...
    socket.on("pollCreated", (pollData) => {
      console.log("✅ TEACHER Poll created successfully:", pollData);
    });
  ...
  const validateForm = () => {
    ...
    const correctOptionExists = options.some((option) => option.correct === true);
  ...
  const askQuestion = () => {
    if (validateForm()) {
      ...
      console.log("📤 TEACHER Emitting createPoll event:", pollData);
